...
/**
 * This Class Contains All Method Related To K2NewsDetailsActivity.
 * 
 * @author tasol
 * 
 */
public class K2NewsDetailsActivity extends K2MasterActivity {
	...
	private class CatalogDetailAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int pos) {
			System.gc();
			return new k2NewsDetailFragment(K2NewsDetailsActivity.this, IN_ITEMS_LIST.get(pos));
		}

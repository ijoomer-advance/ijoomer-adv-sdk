...
/**
 * This Class Contains All Method Related To K2ItemsDetailsActivity.
 * 
 * @author tasol
 * 
 */
public class K2ItemsDetailsActivity extends K2MasterActivity {
	...
	public int setLayoutId() {
		return R.layout.k2_item_details;
	}
	...
	private class CatalogDetailAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int pos) {
			System.gc();
			return new k2ItemsDetailFragment(K2ItemsDetailsActivity.this, IN_ITEMS_LIST.get(pos));
		}

...
public class JomGroupDetailsActivity extends JomMasterActivity {
	...
	public void setActionListeners() {
		...
		txtGroupVideo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				try {
					loadNew(JomVideoActivity.class, JomGroupDetailsActivity.this, false, "IN_USERID", IN_USERID, "IN_PROFILE", "1", "IN_GROUP_ID", IN_GROUP_DETAILS.get(ID), "IN_GROUP_ADD_VIDEO",
							addVideo);
				} catch (Throwable e) {
					e.printStackTrace();
				}

...
public class SobiproSectionCategoryGridFragment extends SmartFragment implements SobiproTagHolder {
	...
	public SobiproSectionCategoryGridFragment(String IN_SECTION_ID, String IN_CAT_ID, String IN_PAGELAYOUT, String IN_FEATUREDFIRST) {
		...
		SmartListAdapterWithHolder adapterWithHolder = new SmartListAdapterWithHolder(getActivity(), R.layout.sobipro_section_category_item, listData, new ItemView() {
			...
			public View setItemView(int position, View v, SmartListItem item, ViewHolder holder) {
				...
				if (position < SobiproMasterActivity.IMAGE_MAX_SIZE) {
					holder.sobiproGridItemLayout.setTag(SobiproMasterActivity.themes[position].getBgColor());
				} else {
					holder.sobiproGridItemLayout.setTag(SobiproMasterActivity.themes[position % SobiproMasterActivity.IMAGE_MAX_SIZE]
							.getBgColor());
				}
				holder.sobiproGridItemLayout.setBackgroundColor((Integer) holder.sobiproGridItemLayout.getTag());

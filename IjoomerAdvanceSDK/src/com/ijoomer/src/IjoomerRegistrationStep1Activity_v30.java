...
public class IjoomerRegistrationStep1Activity_v30 extends IjoomerRegistrationMaster {
	...
	public void initComponents() {
		...
		userphotoLayout = (LinearLayout) findViewById(R.id.userphoto);
	...
	public void prepareViews() {
		...
		if(IjoomerGlobalConfiguration.getRegistrationWith().equalsIgnoreCase("joomla")){
			...
			btnContinue.setText(R.string.submit);
		}
		...
		btnContinue.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View paramView) {
				...
				if (validationFlag) {
					...
					if(IjoomerGlobalConfiguration.getRegistrationWith().equalsIgnoreCase("joomla")){
						new IjoomerRegistration(IjoomerRegistrationStep1Activity_v30.this).signUpJoomlaUser(edtName.getText().toString().trim(), edtUserName.getText()
								.toString().trim(), edtPassword.getText().toString().trim(), edtEmail.getText().toString(), new WebCallListener() {
								...
								if (responseCode == 200) {
									IjoomerUtilities.getCustomOkDialog(getString(R.string.dialog_loading_registration), getString(R.string.registration_successfully), getString(R.string.ok),
										...
										public void NeutralMethod() {
											...
											loadNew(IjoomerLoginActivity.class, IjoomerRegistrationStep1Activity_v30.this, true);
											finish();
										}
									});
								} else {
